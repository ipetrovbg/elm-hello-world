...
var $author$project$Main$FocusOnInput = {$: 7};
...
var $author$project$Main$mayBeIntToInt = function (maybeInt) {
	if (!maybeInt.$) {
...
var $author$project$Main$toInt = function (string) {
	return $elm$core$String$toInt(string);
};
		...
		switch (msg.$) {
			...
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							e: model.e + 1,
							k: $elm$core$String$fromInt(model.e + 1)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
			...
			case 4:
				return A3(
					...
					$author$project$Main$FocusOnInput,
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								k: $elm$core$String$fromInt(model.e),
								o: (!model.o) ? true : false
							}),
						$elm$core$Platform$Cmd$none));
			case 5:
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							e: function () {
								var val = $author$project$Main$mayBeIntToInt(
									$author$project$Main$toInt(
										A3($elm$core$String$replace, '+', '', model.k)));
								return (val >= 0) ? val : 0;
							}(),
							o: (!model.o) ? true : false
						}),
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							e: function () {
								var val = $author$project$Main$mayBeIntToInt(
									$author$project$Main$toInt(content));
								return (val >= 0) ? val : 0;
							}(),
							k: content
						}),
			...
			default:
				return _Utils_Tuple2(
					...
					A2(
						...
						$elm$browser$Browser$Dom$focus('counter-input')));
		}
	});
var $author$project$Main$ConfirmNumber = {$: 5};
...
var $author$project$Main$ShowInput = {$: 4};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('flex justify-content-center align-items-center')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('py-md')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$placeholder('some text'),
										$elm$html$Html$Attributes$id('counter-input'),
										$elm$html$Html$Attributes$value(model.k),
										$elm$html$Html$Events$onInput($author$project$Main$OnInputChange)
									]),
								_List_Nil)
							])) : A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('text-center font text-secondary counter display-inline py-md pointer '),
								$elm$html$Html$Events$onDoubleClick($author$project$Main$ShowInput)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
						...
						_List_fromArray(
							[
								...
								A2(
									$elm$core$String$append,
									'btn font text-secondary ',
									model.o ? 'show' : 'hide')),
								$elm$html$Html$Events$onClick($author$project$Main$ConfirmNumber)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$class('btn primary font title')
							]),
						_List_fromArray(
							[
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'noop', $elm$json$Json$Decode$bool)))(0)}});}(this));